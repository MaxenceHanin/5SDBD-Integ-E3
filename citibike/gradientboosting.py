...
full_data.drop(labels="typ", axis=1, inplace=True)





y_train = full_data["id_d"].values[1:20000]
full_data.drop(labels="id_d", axis=1, inplace=True)

#split data
X_train = full_data.values[1:20000]
